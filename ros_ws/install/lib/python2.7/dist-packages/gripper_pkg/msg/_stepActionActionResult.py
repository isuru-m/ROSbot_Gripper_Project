...
"""autogenerated by genpy from gripper_pkg/stepActionActionResult.msg. Do not edit."""
import sys
...
class stepActionActionResult(genpy.Message):
  _md5sum = "0698ce25b2d595b82357c010557e935f"
  _type = "gripper_pkg/stepActionActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','gripper_pkg/stepActionResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(stepActionActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = gripper_pkg.msg.stepActionResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = gripper_pkg.msg.stepActionResult()
